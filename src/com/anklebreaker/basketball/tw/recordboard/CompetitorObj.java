...
public class CompetitorObj extends Player implements Cloneable{
     ...
     * */
    public static CompetitorObj getInstance(Context c, int act, Bitmap image_check, Bitmap image, 
            String num, String name, boolean isS, boolean isB, boolean isO, String time, int quarter, int x, int y){
        objInstance = null;
